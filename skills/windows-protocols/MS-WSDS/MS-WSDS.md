...
- **Localization:** This protocol includes text strings in various [**SOAP faults**](#gt_soap-fault). Localization considerations for such strings are specified in section [3.1.4](#Section_1.3).
<a id="Section_1.8"></a>
