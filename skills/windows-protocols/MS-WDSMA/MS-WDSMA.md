...
On initialization client MUST wait for packets to arrive from the server using the Lower-Layered Triggered Events as specified in section [3.2.5](#Section_3.1.5).
...
The client MUST reply to the trigger by providing the **MaxCacheSize** value (section [3.2.1](#Section_3.1.1)).
...
**TimeInSession**: MUST be set to (Local Time in Seconds – **JoinTime**) (section [3.2.1](#Section_3.1.1)).
