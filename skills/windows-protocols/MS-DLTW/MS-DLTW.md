...
Maintaining this information allows the client to call the [LnkSearchMachine (section 3.1.4.1)](#Section_4.1) interface.
...
| --- | --- |
| Authenticated users group | [3.1.4.1](#Section_4.1) |
