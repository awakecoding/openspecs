...
The client portion of the diagram in section [3](#Section_1.3) illustrates this sequence for a simple indexing service query.
...
- Wait to receive the [CPMCreateQueryOut](#Section_2.2.3.9) message (see section [3.2.5.1](#Section_2.2.3.9)), silently discarding all other messages.
