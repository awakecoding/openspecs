...
| [2.2.4](#Section_2.2.4) Processing | 11487 : Added terminating condition to pseudocode for when the input buffer does not have enough room for the Huffman table. | Major |
