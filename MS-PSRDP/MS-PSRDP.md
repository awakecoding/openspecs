...
When the server receives this message, it MUST update its **Debugger_UnhandledBreakpoint_Mode** state as provided by the message argument specified in section [2.2.6](#Section_2.2.6).
